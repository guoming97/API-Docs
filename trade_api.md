...
用户的API权限在网站的个人中心->我的API内获取。点击申请API即可获得，其中API Key是平台提供给API用户的访问密钥，API Secret是用于对请求参数签名的私钥。
...
- 示例
```
curl -H 'key: xxx' -H 'sign: yyy' -H 'version: 2.0' -X POST https://api.cloudservicex.com/symbol/list -d 'nonce=1536826456'
```
...
- 示例
```
curl -H 'key: xxx' -H 'sign: yyy' -H 'version: 2.0' -X POST https://api.cloudservicex.com/balance/list -d 'nonce=1536826456'
```
...
- 示例
```
curl -H 'key: xxx' -H 'sign: yyy' -H 'version: 2.0' -X POST https://api.cloudservicex.com/order/create -d 'nonce=1536826456&symbol=BTC_USDT&side=1&type=1&price=6000&amount=1'
```
...
- 示例
```
curl -H 'key: xxx' -H 'sign: yyy' -H 'version: 2.0' -X POST https://api.cloudservicex.com/order/remove -d 'nonce=1536826456&symbol=BTC_USDT&order_id=123'
```
...
- 示例
```
curl -H 'key: xxx' -H 'sign: yyy' -H 'version: 2.0' -X POST https://api.cloudservicex.com/order/active -d 'nonce=1536826456&symbol=BTC_USDT&page=1&size=10'
```
...
- 字段说明
  ...
  - update_time 最近成交时间
```
curl -H 'key: xxx' -H 'sign: yyy' -H 'version: 2.0' -X POST https://api.cloudservicex.com/order/history -d 'nonce=1536826456&page=1&size=10'
```
...
- 字段说明
  ...
  - update_time 最近成交时间
```
curl -H 'key: xxx' -H 'sign: yyy' -H 'version: 2.0' -X POST https://api.cloudservicex.com/order/query -d 'nonce=1536826456&symbol=BTC_USDT&order_id=123'
```